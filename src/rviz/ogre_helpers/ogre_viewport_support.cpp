...
void OgreViewportSupport::preViewportUpdate(const Ogre::RenderTargetViewportEvent& evt)
{
...
void OgreViewportSupport::postViewportUpdate(const Ogre::RenderTargetViewportEvent& evt)
{
  Ogre::Viewport* viewport = evt.source;
